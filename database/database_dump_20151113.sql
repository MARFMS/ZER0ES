...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`snippet_id`) REFERENCES `snippets` (`id`)
...
CREATE TABLE `snippets` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `snippets_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
-- Dump completed on 2015-11-13 18:33:32
